...
public class NeuralNetwork {
    ...
    private double[] hidden_layer_bias;
    private double[] output_layer_bias;
    ...
    public double[][][] backward_propagate_error(double[] inputs, double[] hidden_layer_outputs,
       ...
       //System.out.println("OL betas: " + Arrays.toString(output_layer_betas));
        ...
        update_bias(delta_output_layer_bias, delta_hidden_layer_bias);
    ...
    public void update_bias(double[] delta_output_layer_bias, double[] delta_hidden_layer_bias) {
    	
    	for(int i=0; i<hidden_layer_bias.length; i++) {
    		
    		hidden_layer_bias[i] = hidden_layer_bias[i] + delta_hidden_layer_bias[i];
    		
    	}
    	
    	for(int i=0; i<output_layer_bias.length; i++) {
    		
    		output_layer_bias[i] = output_layer_bias[i] + delta_output_layer_bias[i];
...
//            System.out.println("Output layer weights  \n" + Arrays.deepToString(output_layer_weights));
            ...
            if(epoch == 99){
                System.out.println("\nAccuracy on train set after 100 epochs = " + acc + "\n");
            }
